package com.project.jwtspringsec;

import com.project.jwtspringsec.login.filter.JWTBasicAuthenticationFilter;
import com.project.jwtspringsec.login.filter.JWTUsernamePasswordAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .csrf().disable()//para fins educacionais, não use disable em desenvolvimento de projetos reais
                .authorizeRequests()
